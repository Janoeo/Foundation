...
public class SmeltingBlastingRecipes extends RecipeProvider {
    ...
    protected void registerRecipes(Consumer<IFinishedRecipe> consumer) {
        ...
        this.registerSmeltingBlasting(OverworldOresBlocks.Ores.get("COPPER_ORE"), AllItems.Ingots.COPPER,"has_copper_ore", consumer);
        this.registerSmeltingBlasting(OverworldOresBlocks.Ores.get("TIN_ORE"), AllItems.Ingots.TIN, "has_tin_ore", consumer);
        this.registerSmeltingBlasting(OverworldOresBlocks.Ores.get("ALUMINIUM_ORE"), AllItems.Ingots.ALUMINIUM, "has_aluminium_ore", consumer);
        this.registerSmeltingBlasting(OverworldOresBlocks.Ores.get("LEAD_ORE"), AllItems.Ingots.LEAD, "has_lead_ore", consumer);
        this.registerSmeltingBlasting(OverworldOresBlocks.Ores.get("SILVER_ORE"), AllItems.Ingots.SILVER, "has_silver_ore", consumer);
        this.registerSmeltingBlasting(OverworldOresBlocks.Ores.get("URANIUM_ORE"), AllItems.Ingots.URANIUM, "has_uranium_ore", consumer);
        this.registerSmeltingBlasting(OverworldOresBlocks.Ores.get("OSMIUM_ORE"), AllItems.Ingots.OSMIUM, "has_osmium_ore", consumer);
        this.registerSmeltingBlasting(OverworldOresBlocks.Ores.get("RUBY_ORE"), AllItems.Gems.RUBY, "has_ruby_ore", consumer);
        this.registerSmeltingBlasting(OverworldOresBlocks.Ores.get("SAPPHIRE_ORE"), AllItems.Gems.SAPPHIRE, "has_sapphire_ore", consumer);
        this.registerSmeltingBlasting(OverworldOresBlocks.Ores.get("AMETHYST_ORE"), AllItems.Gems.AMETHYST, "has_amethyst_ore", consumer);
        this.registerSmeltingBlasting(OverworldOresBlocks.Ores.get("ZINC_ORE"), AllItems.Ingots.ZINC, "has_zinc_ore", consumer);
