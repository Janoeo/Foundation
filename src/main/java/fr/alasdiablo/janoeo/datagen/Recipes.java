...
public class Recipes extends RecipeProvider {
    ...
    protected void registerRecipes(Consumer<IFinishedRecipe> consumer) {
        this.basaltOreSmelting(consumer);
        this.basaltOreBlasting(consumer);
    ...
    private void basaltOreSmelting(Consumer<IFinishedRecipe> consumer) {
        // coal
        CookingRecipeBuilder.smeltingRecipe(Ingredient.fromItems(BasaltOresBlocks.COAL_BASALT_ORE), Items.COAL, 0.1f, 200)
                .addCriterion("has_basalt_coal_ore", hasItem(BasaltOresBlocks.COAL_BASALT_ORE)).build(consumer, "coal_basalt_smelting");
        // diamond
        CookingRecipeBuilder.smeltingRecipe(Ingredient.fromItems(BasaltOresBlocks.DIAMOND_BASALT_ORE), Items.DIAMOND, 0.1f, 200)
                .addCriterion("has_basalt_diamond_ore", hasItem(BasaltOresBlocks.DIAMOND_BASALT_ORE)).build(consumer, "diamond_basalt_smelting");
        // emerald
        CookingRecipeBuilder.smeltingRecipe(Ingredient.fromItems(BasaltOresBlocks.EMERALD_BASALT_ORE), Items.EMERALD, 0.1f, 200)
                .addCriterion("has_basalt_emerald_ore", hasItem(BasaltOresBlocks.EMERALD_BASALT_ORE)).build(consumer, "emerald_basalt_smelting");
        // gold
        CookingRecipeBuilder.smeltingRecipe(Ingredient.fromItems(BasaltOresBlocks.GOLD_BASALT_ORE), Items.GOLD_INGOT, 0.1f, 200)
                .addCriterion("has_basalt_gold_ore", hasItem(BasaltOresBlocks.GOLD_BASALT_ORE)).build(consumer, "gold_basalt_smelting");
        // iron
        CookingRecipeBuilder.smeltingRecipe(Ingredient.fromItems(BasaltOresBlocks.IRON_BASALT_ORE), Items.IRON_INGOT, 0.1f, 200)
                .addCriterion("has_basalt_iron_ore", hasItem(BasaltOresBlocks.IRON_BASALT_ORE)).build(consumer, "iron_basalt_smelting");
        // lapis
        CookingRecipeBuilder.smeltingRecipe(Ingredient.fromItems(BasaltOresBlocks.LAPIS_BASALT_ORE), Items.LAPIS_LAZULI, 0.1f, 200)
                .addCriterion("has_basalt_lapis_ore", hasItem(BasaltOresBlocks.LAPIS_BASALT_ORE)).build(consumer, "lapis_basalt_smelting");
        // redstone
        CookingRecipeBuilder.smeltingRecipe(Ingredient.fromItems(BasaltOresBlocks.REDSTONE_BASALT_ORE), Items.REDSTONE, 0.1f, 200)
                .addCriterion("has_basalt_redstone_ore", hasItem(BasaltOresBlocks.REDSTONE_BASALT_ORE)).build(consumer, "redstone_basalt_smelting");
    }

    private void basaltOreBlasting(Consumer<IFinishedRecipe> consumer) {
        // coal
        CookingRecipeBuilder.blastingRecipe(Ingredient.fromItems(BasaltOresBlocks.COAL_BASALT_ORE), Items.COAL, 0.1f, 100)
                .addCriterion("has_basalt_coal_ore", hasItem(BasaltOresBlocks.COAL_BASALT_ORE)).build(consumer, "coal_basalt_blasting");
        // diamond
        CookingRecipeBuilder.blastingRecipe(Ingredient.fromItems(BasaltOresBlocks.DIAMOND_BASALT_ORE), Items.DIAMOND, 0.1f, 100)
                .addCriterion("has_basalt_diamond_ore", hasItem(BasaltOresBlocks.DIAMOND_BASALT_ORE)).build(consumer, "diamond_basalt_blasting");
        // emerald
        CookingRecipeBuilder.blastingRecipe(Ingredient.fromItems(BasaltOresBlocks.EMERALD_BASALT_ORE), Items.EMERALD, 0.1f, 100)
                .addCriterion("has_basalt_emerald_ore", hasItem(BasaltOresBlocks.EMERALD_BASALT_ORE)).build(consumer, "emerald_basalt_blasting");
        // gold
        CookingRecipeBuilder.blastingRecipe(Ingredient.fromItems(BasaltOresBlocks.GOLD_BASALT_ORE), Items.GOLD_INGOT, 0.1f, 100)
                .addCriterion("has_basalt_gold_ore", hasItem(BasaltOresBlocks.GOLD_BASALT_ORE)).build(consumer, "gold_basalt_blasting");
        // iron
        CookingRecipeBuilder.blastingRecipe(Ingredient.fromItems(BasaltOresBlocks.IRON_BASALT_ORE), Items.IRON_INGOT, 0.1f, 100)
                .addCriterion("has_basalt_iron_ore", hasItem(BasaltOresBlocks.IRON_BASALT_ORE)).build(consumer, "iron_basalt_blasting");
        // lapis
        CookingRecipeBuilder.blastingRecipe(Ingredient.fromItems(BasaltOresBlocks.LAPIS_BASALT_ORE), Items.LAPIS_LAZULI, 0.1f, 100)
                .addCriterion("has_basalt_lapis_ore", hasItem(BasaltOresBlocks.LAPIS_BASALT_ORE)).build(consumer, "lapis_basalt_blasting");
        // redstone
        CookingRecipeBuilder.blastingRecipe(Ingredient.fromItems(BasaltOresBlocks.REDSTONE_BASALT_ORE), Items.REDSTONE, 0.1f, 100)
                .addCriterion("has_basalt_redstone_ore", hasItem(BasaltOresBlocks.REDSTONE_BASALT_ORE)).build(consumer, "redstone_basalt_blasting");
    }
