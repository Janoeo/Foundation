...
public class FoundationPlacements {
    ...
    /* * * * * * * * * * * * * * * Nether Ore * * *  * * * * * * * * * * */
    public static final PlacedFeature NETHER_COAL_ORE     = createPlacedFeature(FoundationFeatures.NETHER_COAL_ORE, FoundationConfig.NETHER_COAL_ORE_CONFIG);
    public static final PlacedFeature NETHER_COPPER_ORE   = createPlacedFeature(
            FoundationFeatures.NETHER_COPPER_ORE, FoundationConfig.NETHER_COPPER_ORE_CONFIG);
    public static final PlacedFeature NETHER_DIAMOND_ORE  = createPlacedFeature(
            FoundationFeatures.NETHER_DIAMOND_ORE, FoundationConfig.NETHER_DIAMOND_ORE_CONFIG);
    public static final PlacedFeature NETHER_EMERALD_ORE  = createPlacedFeature(
            FoundationFeatures.NETHER_EMERALD_ORE, FoundationConfig.NETHER_EMERALD_ORE_CONFIG);
    public static final PlacedFeature NETHER_IRON_ORE     = createPlacedFeature(FoundationFeatures.NETHER_IRON_ORE, FoundationConfig.NETHER_IRON_ORE_CONFIG);
    public static final PlacedFeature NETHER_LAPIS_ORE    = createPlacedFeature(FoundationFeatures.NETHER_LAPIS_ORE, FoundationConfig.NETHER_LAPIS_ORE_CONFIG);
    public static final PlacedFeature NETHER_REDSTONE_ORE = createPlacedFeature(
            FoundationFeatures.NETHER_REDSTONE_ORE, FoundationConfig.NETHER_REDSTONE_ORE_CONFIG);

    public static final PlacedFeature NETHER_BAUXITE_ORE = createPlacedFeature(
            FoundationFeatures.NETHER_BAUXITE_ORE, FoundationConfig.NETHER_BAUXITE_ORE_CONFIG);
    public static final PlacedFeature NETHER_LEAD_ORE    = createPlacedFeature(FoundationFeatures.NETHER_LEAD_ORE, FoundationConfig.NETHER_LEAD_ORE_CONFIG);
    public static final PlacedFeature NETHER_NICKEL_ORE  = createPlacedFeature(FoundationFeatures.NETHER_NICKEL_ORE, FoundationConfig.NETHER_NICKEL_ORE_CONFIG);
    public static final PlacedFeature NETHER_SILVER_ORE  = createPlacedFeature(FoundationFeatures.NETHER_SILVER_ORE, FoundationConfig.NETHER_SILVER_ORE_CONFIG);
    public static final PlacedFeature NETHER_TIN_ORE     = createPlacedFeature(FoundationFeatures.NETHER_TIN_ORE, FoundationConfig.NETHER_TIN_ORE_CONFIG);
