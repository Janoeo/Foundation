...
public class FoundationBlockModelProvider extends BlockModelProvider {
    ...
    protected void registerModels() {
        ...
        List<String> tinyOres = Arrays.asList(
                TINY_COAL_ORE, TINY_COPPER_ORE, TINY_DIAMOND_ORE, TINY_EMERALD_ORE, TINY_GOLD_ORE, TINY_IRON_ORE,
                TINY_LAPIS_ORE, TINY_REDSTONE_ORE, DEEPSLATE_TINY_COAL_ORE, DEEPSLATE_TINY_COPPER_ORE,
    ...
    private void cubeAll(String blockNameIn, Folder folder) {
        withExistingParent(blockNameIn, CUBE_ALL)
                .texture("all", new ResourceLocation(MOD_ID, "block/" + folder.getFolder() + blockNameIn));
    }
