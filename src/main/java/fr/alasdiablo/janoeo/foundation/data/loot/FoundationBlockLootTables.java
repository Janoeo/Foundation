...
public class FoundationBlockLootTables extends DioBlockLootTables {
    ...
    protected void addTables() {
        ...
        this.registerOreLootTable(
                ...
                FoundationBlocks.DEEPSLATE_TINY_BAUXITE_ORE
        );
        this.registerOreLootTable(
                FoundationItems.LEAD_NUGGET, UniformGenerator.between(2.0F, 6.0F), FoundationBlocks.TINY_LEAD_ORE, FoundationBlocks.DEEPSLATE_TINY_LEAD_ORE);
        this.registerOreLootTable(
        ...
        this.registerOreLootTable(
                FoundationItems.TIN_NUGGET, UniformGenerator.between(2.0F, 6.0F), FoundationBlocks.TINY_TIN_ORE, FoundationBlocks.DEEPSLATE_TINY_TIN_ORE);
        this.registerOreLootTable(
        ...
        this.registerOreLootTable(
                FoundationItems.COAL_NUGGET, UniformGenerator.between(2.0F, 6.0F), FoundationBlocks.TINY_COAL_ORE, FoundationBlocks.DEEPSLATE_TINY_COAL_ORE);
        this.registerOreLootTable(
        ...
        this.registerOreLootTable(
                Items.IRON_NUGGET, UniformGenerator.between(2.0F, 6.0F), FoundationBlocks.TINY_IRON_ORE, FoundationBlocks.DEEPSLATE_TINY_IRON_ORE);
        this.registerOreLootTable(
                FoundationItems.LAPIS_NUGGET, UniformGenerator.between(2.0F, 6.0F), FoundationBlocks.TINY_LAPIS_ORE, FoundationBlocks.DEEPSLATE_TINY_LAPIS_ORE);
        this.registerOreLootTable(
                FoundationItems.REDSTONE_NUGGET, UniformGenerator.between(2.0F, 6.0F), FoundationBlocks.TINY_REDSTONE_ORE,
                FoundationBlocks.DEEPSLATE_TINY_REDSTONE_ORE
        );
    }
