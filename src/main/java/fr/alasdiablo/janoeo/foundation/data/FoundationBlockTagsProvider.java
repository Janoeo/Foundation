...
public class FoundationBlockTagsProvider extends BlockTagsProvider {
    ...
    protected void addTags() {
        ...
        this.tag(BlockTags.MINEABLE_WITH_PICKAXE).add(
                ...
                TINY_BAUXITE_ORE, TINY_LEAD_ORE, TINY_NICKEL_ORE, TINY_SILVER_ORE,TINY_TIN_ORE,
                TINY_URANIUM_ORE, DEEPSLATE_TINY_BAUXITE_ORE, DEEPSLATE_TINY_LEAD_ORE,
        ...
        this.tag(BlockTags.NEEDS_STONE_TOOL).add(
                ...
                DEEPSLATE_TIN_ORE, TINY_COPPER_ORE,
                TINY_IRON_ORE, DEEPSLATE_TINY_COPPER_ORE,
                DEEPSLATE_TINY_IRON_ORE,

                TINY_BAUXITE_ORE, TINY_LEAD_ORE, TINY_TIN_ORE,
                DEEPSLATE_TINY_BAUXITE_ORE, DEEPSLATE_TINY_LEAD_ORE,
                DEEPSLATE_TINY_TIN_ORE
        );
        this.tag(BlockTags.NEEDS_IRON_TOOL).add(
                NICKEL_ORE, SILVER_ORE, URANIUM_ORE,
                DEEPSLATE_NICKEL_ORE, DEEPSLATE_SILVER_ORE,
                DEEPSLATE_URANIUM_ORE, TINY_DIAMOND_ORE,
                ...
                TINY_NICKEL_ORE, TINY_SILVER_ORE, TINY_URANIUM_ORE,
                DEEPSLATE_TINY_NICKEL_ORE, DEEPSLATE_TINY_SILVER_ORE,
                DEEPSLATE_TINY_URANIUM_ORE
        );
    }
