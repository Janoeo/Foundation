...
public class FoundationBlockTagsProvider extends BlockTagsProvider {
    ...
    protected void addTags() {
        ...
        this.tag(ORES_ALUMINIUM).add(BAUXITE_ORE, DEEPSLATE_BAUXITE_ORE);
        this.tag(ORES_LEAD).add(LEAD_ORE, DEEPSLATE_LEAD_ORE);
        this.tag(ORES_NICKEL).add(NICKEL_ORE, DEEPSLATE_NICKEL_ORE);
        this.tag(ORES_SILVER).add(SILVER_ORE, DEEPSLATE_SILVER_ORE);
        this.tag(ORES_TIN).add(TIN_ORE, DEEPSLATE_TIN_ORE);
        this.tag(ORES_URANIUM).add(URANIUM_ORE, DEEPSLATE_URANIUM_ORE);
        ...
        this.tag(BlockTags.NEEDS_STONE_TOOL).add(
                BAUXITE_ORE, LEAD_ORE, TIN_ORE, DEEPSLATE_BAUXITE_ORE, DEEPSLATE_LEAD_ORE, DEEPSLATE_TIN_ORE,
                TINY_COPPER_ORE, TINY_IRON_ORE, DEEPSLATE_TINY_COPPER_ORE, DEEPSLATE_TINY_IRON_ORE, TINY_BAUXITE_ORE,
                TINY_LEAD_ORE, TINY_TIN_ORE, DEEPSLATE_TINY_BAUXITE_ORE, DEEPSLATE_TINY_LEAD_ORE, DEEPSLATE_TINY_TIN_ORE
        );
        this.tag(BlockTags.NEEDS_IRON_TOOL).add(
                NICKEL_ORE, SILVER_ORE, URANIUM_ORE, DEEPSLATE_NICKEL_ORE, DEEPSLATE_SILVER_ORE, DEEPSLATE_URANIUM_ORE,
                TINY_DIAMOND_ORE, TINY_EMERALD_ORE, TINY_GOLD_ORE, TINY_LAPIS_ORE, TINY_REDSTONE_ORE,
                DEEPSLATE_TINY_DIAMOND_ORE, DEEPSLATE_TINY_EMERALD_ORE, DEEPSLATE_TINY_GOLD_ORE,
                DEEPSLATE_TINY_LAPIS_ORE, DEEPSLATE_TINY_REDSTONE_ORE, TINY_NICKEL_ORE, TINY_SILVER_ORE,
                TINY_URANIUM_ORE, DEEPSLATE_TINY_NICKEL_ORE, DEEPSLATE_TINY_SILVER_ORE, DEEPSLATE_TINY_URANIUM_ORE
        );
    }
