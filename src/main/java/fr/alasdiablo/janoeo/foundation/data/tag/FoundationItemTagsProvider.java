...
public class FoundationItemTagsProvider extends ItemTagsProvider {
    ...
    protected void addTags() {
        ...
        this.tag(RODS_COPPER).add(COPPER_STICK.get());
        this.tag(RODS_DIAMOND).add(DIAMOND_STICK.get());
        this.tag(RODS_GOLD).add(GOLD_STICK.get());
        this.tag(RODS_IRON).add(IRON_STICK.get());
        this.tag(RODS_SILVER).add(SILVER_STICK.get());
        this.tag(RODS_TIN).add(TIN_STICK.get());
        ...
        this.tag(DUSTS_ALUMINIUM).add(ALUMINIUM_DUST.get());
        this.tag(DUSTS_ALUMINUM).addTags(DUSTS_ALUMINIUM); // Reference to DUSTS_ALUMINIUM
        this.tag(DUSTS_AMETHYST).add(AMETHYST_DUST.get());
        ...
        this.tag(NUGGETS_ALUMINIUM).add(ALUMINIUM_NUGGET.get());
        ...
        this.tag(INGOTS_ALUMINIUM).add(ALUMINIUM_INGOT.get());
        ...
        this.tag(RAW_MATERIALS_ALUMINIUM).add(RAW_ALUMINIUM.get());
