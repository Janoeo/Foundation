...
public class FoundationConfig {
    ...
    /* * * * * * * * * * * * * * * Ore * * *  * * * * * * * * * * */
    public static final OreConfig BAUXITE_ORE_CONFIG = new OreConfig(Registries.BAUXITE_ORE, true).placementUniform(10, 8, 96, 6);
    public static final OreConfig LEAD_ORE_CONFIG = new OreConfig(Registries.LEAD_ORE, true).placementUniform(6, -16, 48, 6);
    public static final OreConfig NICKEL_ORE_CONFIG = new OreConfig(Registries.NICKEL_ORE, true).placementUniform(6, -24, 32, 4);
    public static final OreConfig SILVER_ORE_CONFIG = new OreConfig(Registries.SILVER_ORE, true).placementUniform(6, -56, 28, 6);
    public static final OreConfig TIN_ORE_CONFIG = new OreConfig(Registries.TIN_ORE, true).placementUniform(10, 0, 96, 8);
    public static final OreConfig URANIUM_ORE_CONFIG = new OreConfig(Registries.URANIUM_ORE, true).placementUniform(6, -56, 28, 6);
    ...
    public static final OreConfig TINY_DIAMOND_ORE_CONFIG = new OreConfig(Registries.TINY_DIAMOND_ORE, true).placementUniform(8, -62, 16, 4);
    public static final OreConfig TINY_EMERALD_ORE_CONFIG = new OreConfig(Registries.TINY_EMERALD_ORE, true).placementUniform(2, 24, 31, 4);
    public static final OreConfig TINY_GOLD_ORE_CONFIG = new OreConfig(Registries.TINY_GOLD_ORE, true).placementUniform(9, -62, 32, 2);
    ...
    public static final OreConfig TINY_REDSTONE_ORE_CONFIG = new OreConfig(Registries.TINY_REDSTONE_ORE, true).placementUniform(8, -62, 16, 8);

    public static final OreConfig TINY_BAUXITE_ORE_CONFIG = new OreConfig(Registries.TINY_BAUXITE_ORE, true).placementUniform(10, 8, 96, 6);
    public static final OreConfig TINY_LEAD_ORE_CONFIG = new OreConfig(Registries.TINY_LEAD_ORE, true).placementUniform(6, -16, 48, 6);
    public static final OreConfig TINY_NICKEL_ORE_CONFIG = new OreConfig(Registries.TINY_NICKEL_ORE, true).placementUniform(6, -24, 32, 4);
    public static final OreConfig TINY_SILVER_ORE_CONFIG = new OreConfig(Registries.TINY_SILVER_ORE, true).placementUniform(6, -56, 28, 4);
    public static final OreConfig TINY_TIN_ORE_CONFIG = new OreConfig(Registries.TINY_TIN_ORE, true).placementUniform(10, 0, 96, 8);
    public static final OreConfig TINY_URANIUM_ORE_CONFIG = new OreConfig(Registries.TINY_URANIUM_ORE, true).placementUniform(6, -56, 28, 6);
