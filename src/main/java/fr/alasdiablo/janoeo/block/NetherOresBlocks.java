...
public class NetherOresBlocks {
    ...
    public static Block ALUMINIUM_NETHER_ORE = new NetherOre(Registries.ALUMINIUM_NETHER_ORE);

    public static Block COAL_NETHER_ORE = new NetherOre(Registries.COAL_NETHER_ORE);

    public static Block COPPER_NETHER_ORE = new NetherOre(Registries.COPPER_NETHER_ORE);

    public static Block DIAMOND_NETHER_ORE = new NetherOre(Registries.DIAMOND_NETHER_ORE);

    public static Block EMERALD_NETHER_ORE = new NetherOre(Registries.EMERALD_NETHER_ORE);

    public static Block GOLD_NETHER_ORE = new NetherOre(Registries.GOLD_NETHER_ORE);

    public static Block IRON_NETHER_ORE = new NetherOre(Registries.IRON_NETHER_ORE);

    public static Block LAPIS_NETHER_ORE = new NetherOre(Registries.LAPIS_NETHER_ORE);

    public static Block LEAD_NETHER_ORE = new NetherOre(Registries.LEAD_NETHER_ORE);

    public static Block REDSTONE_NETHER_ORE = new NetherRedstoneOre(Registries.REDSTONE_NETHER_ORE);

    public static Block RUBY_NETHER_ORE = new NetherOre(Registries.RUBY_NETHER_ORE);

    public static Block SAPPHIRE_NETHER_ORE = new NetherOre(Registries.SAPPHIRE_NETHER_ORE);

    public static Block SILVER_NETHER_ORE = new NetherOre(Registries.SILVER_NETHER_ORE);

    public static Block TIN_NETHER_ORE = new NetherOre(Registries.TIN_NETHER_ORE);

    public static Block URANIUM_NETHER_ORE = new NetherOre(Registries.URANIUM_NETHER_ORE);
    ...
    public static class RegistryEvents {
        ...
        public static void onBlocksRegistry(final RegistryEvent.Register<Block> event) {
            Utils.registerBlock(event.getRegistry(),
                    ALUMINIUM_NETHER_ORE, COAL_NETHER_ORE,
                    COPPER_NETHER_ORE, DIAMOND_NETHER_ORE,
                    EMERALD_NETHER_ORE, GOLD_NETHER_ORE,
                    IRON_NETHER_ORE, LAPIS_NETHER_ORE,
                    LEAD_NETHER_ORE, REDSTONE_NETHER_ORE,
                    RUBY_NETHER_ORE, SAPPHIRE_NETHER_ORE,
                    SILVER_NETHER_ORE, TIN_NETHER_ORE,
                    URANIUM_NETHER_ORE
            );
        }
